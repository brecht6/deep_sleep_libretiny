 ...
 */
class DeepSleepLibretiny : public Component {
 public:
...
template<typename... Ts> class EnterDeepSleepAction : public Action<Ts...> {
 public:
  EnterDeepSleepAction(DeepSleepLibretiny *deep_sleep) : deep_sleep_(deep_sleep) {}
 ...
 protected:
  DeepSleepLibretiny *deep_sleep_;
#ifdef USE_TIME
...
template<typename... Ts> class PreventDeepSleepAction : public Action<Ts...>, public Parented<DeepSleepLibretiny> {
 public:
  void play(Ts... x) override { this->parent_->prevent_deep_sleep(); }
};

template<typename... Ts> class AllowDeepSleepAction : public Action<Ts...>, public Parented<DeepSleepLibretiny> {
 public:
